...
import { GraduationCap, Mail, Lock, User, ArrowRight, Sparkles, Eye, EyeOff, Check } from "lucide-react";
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center gradient-primary relative overflow-hidden">
        ...
        >
          ...
          <p className="text-lg text-white/80 max-w-md mx-auto">
            Join 50,000+ learners who are already transforming their skills with AI-powered education.
          </p>
        ...
        <div className="absolute bottom-20 left-20 w-40 h-40 rounded-full bg-white/10 blur-2xl animate-float" style={{ animationDelay: "-3s" }} />
      </div>
